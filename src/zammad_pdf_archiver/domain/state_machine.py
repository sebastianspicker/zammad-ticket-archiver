...
async def apply_processing(client, ticket_id: int, *, trigger_tag: str = TRIGGER_TAG) -> None:
...
async def apply_done(client, ticket_id: int, *, trigger_tag: str = TRIGGER_TAG) -> None:
